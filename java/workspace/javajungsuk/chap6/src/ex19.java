...
public class ex19 {
 ...
 // 실행 결과 :  ABC123
 //            After change: ABC123456   --> String 기본형이 아니므로  참조형 매개변수로 생각해서 답을 생각해냄 

// ******* 그러나 change()에서 문자열 주소를 넘겨받은 후에  456을 붙이고, 문자열은 내용을 변경할 수 없기 때문에 새로운 문자열이 생성되고,새 주소가 str 에 저장됨 
