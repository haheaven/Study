...
import static java.util.Comparator.*;
		...
		class Student2 {
			...
			Student2(String name, boolean isMale, int hak, int ban, int scrore) {
				this.name = name;
				this.isMale = isMale;
				this.hak = hak;
				this.ban = ban;
		...
		Student2[] stuArr=  {
			...
			new Student2("안지미",true , 1, 2,   50),
			new Student2("나자바",false, 1 ,3 , 100),
			new Student2("황지미",false, 1 ,3 , 150),
			new Student2("강지미",false, 1 ,3 , 200),
			...
			new Student2("나자바",false, 2 ,3 , 100),
			new Student2("황지미",false, 2 ,3 , 150),
			new Student2("강지미",false, 2 ,3 , 200)
		...
		Map<Boolean, List<Student2>> stuBySex = Stream.of(stuArr)
			...
			for(Student2 s : maleStudent) System.out.println(true);
			for(Student2 s : femaleStudent) System.out.println(false);
			...
			Map<Boolean, Optional<Student2>> topScoreBySex1= Stream.of(stuArr)
					.collect(partitioningBy(Student2::isMale,
							maxBy(comparingInt(Student2::getScore)) ));
			System.out.println("남학생 1등 :" + topScoreBySex1.get(true));
			System.out.println("여학생 1등 :" + topScoreBySex1.get(false));
